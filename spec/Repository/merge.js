...
exports.spec = function(){
    describe('Repository#merge()', function() {
        ...
        context("when merging divergent commit with changes (their removal) at the same path", function() {
            let repo = new jsodvcs.Repository();
            let outA = {};
            let outB = {};
            let outX = {};
        ...
        context("when merging divergent commit with changes (mine removal) at the same path", function() {
            let repo = new jsodvcs.Repository();
            let outA = {};
            let outB = {};
            let outX = {};
            repo.add("foo/bar", 42).commit({out:outX});
            repo.branch("branchA").checkout("branchA");
            repo.remove("foo/bar").commit({out:outA});
            repo.checkout("master");
            repo.branch("branchB").checkout("branchB");
