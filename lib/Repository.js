...
class Repository
{
    ...
    {
        options = _.extend({}, options);
        let sourceContent = this.get_indexed_hash(sourcePath);
        let destinationContent = this.get_indexed_hash(destinationPath);
        if(!_.isUndefined(sourceContent))
        {
            let shouldMove = false;
            if(!_.isUndefined(destinationContent))
            {
            ...
            if(shouldMove)
            {
                this.index[destinationPath] = sourceContent;
