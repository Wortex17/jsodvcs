...
class Repository
{
    ...
    /**
     * Returns the hash the given ref is pointing at.
     * @param {string} ref
    ...
    /**
     * Returns the commit HEAD is currently pointing to.
     * @returns {Object|undefined}
     */
    get_head_commit()
    {
        let commitHash = this.get_head();
        if(_.isUndefined(commitHash))
            return undefined;
        return getFromObjects(commitHash, this.objects);
    }

    /**
     * Returns the hash the HEAD ref is pointing to.
     * @return {string|undefined}
     */
    get_head()
    {
        return this.get_ref(this.HEAD);
    }
