...
class Repository
{
    ...
    /**
     * Show changes between the current index and a tree or the changes between two trees.
     * @param {string} tree_ishA - The tree, identified by treeHash, commitHash or ref, that should be compared.
     * @param {string|undefined} [tree_ishB=undefined] - The other tree that should be compared. By default, the current index is used.
     *
     * @return {Array.<string>|undefined} - Returns undefined if one of the targets to diff was not found.
     */
