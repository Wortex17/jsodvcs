...
class RepositoryObjectStorage
{
    ...
    get(objectHash)
    {
        ...
        return this.storage[cKeys[0]][cKeys[1]];
    }
    ...
    set(objectHash, objectContent)
    {
        ...
        this.storage[cKeys[0]][cKeys[1]] = objectContent;
        return this;
    }
...
class Repository
{
    ...
    get_tree(tree_ish)
    {
        let tree = this.objects.get(tree_ish);
    ...
    get_indexed_content(path)
    {
        ...
        if(_.isUndefined(objectHash))
        {
            ...
            return this.objects.get(objectHash);
        }
    }
    ...
    update_index(path, content, options)
    {
        ...
        if(_.isUndefined(content))
        {
            ...
            if (isIndexed || options.add) {
                ...
                if (!this.objects.contain(objectHash)) {
                    this.objects.set(objectHash, content);
                }
    ...
    commit(message, options)
    {
        ...
        if (!this.objects.contain(treeHash)) {
            this.objects.set(treeHash, tree);
        }
        ...
        if (!this.objects.contain(commitHash)) {
            this.objects.set(commitHash, commitObject);
        }
